...
//			System.out.println("res/textures/" + heightMap + "." + "png");
	...
	public float getHeightOfTerrain(float worldX, float worldZ) {
		...
		if (xCoord <= (1 - zCoord)) {
			answer = Maths.barycentric(new Vector3f(0, heights[gridX][gridZ], 0),
					new Vector3f(1, heights[gridX + 1][gridZ], 1), new Vector3f(0, heights[gridX][gridZ + 1], 1),
					new Vector2f(xCoord, zCoord));
		} else {
			answer = Maths.barycentric(new Vector3f(1, heights[gridX + 1][gridZ], 0),
